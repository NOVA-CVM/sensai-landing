  ...
  return (
    <main style={{ background: '#ffffff', minHeight: '100vh' }}>
      <div style={{ maxWidth: 760, margin: '0 auto', padding: '88px 24px 120px' }}>
        ...
        <p style={{ margin: "14px 0 0", fontSize: 15.5, lineHeight: 1.7, color: SENS.inkSoft }} dangerouslySetInnerHTML={{ __html: `<strong>Last updated:</strong> 15 September 2026` }} />
        <h2 style={{ margin: "38px 0 0", fontSize: 20, fontWeight: 600, letterSpacing: -0.3, color: SENS.ink }}>Who we are</h2>
        <p style={{ margin: "14px 0 0", fontSize: 15.5, lineHeight: 1.7, color: SENS.inkSoft }} dangerouslySetInnerHTML={{ __html: `This website is operated by <strong>Sensai Technologies, Inc.</strong>, a Delaware corporation ("we", "us").` }} />
        <p style={{ margin: "14px 0 0", fontSize: 15.5, lineHeight: 1.7, color: SENS.inkSoft }} dangerouslySetInnerHTML={{ __html: `For any question about this policy or about your data, contact us at <strong>privacy@getsensai.co</strong>.` }} />
        ...
        <p style={{ margin: "14px 0 0", fontSize: 15.5, lineHeight: 1.7, color: SENS.inkSoft }} dangerouslySetInnerHTML={{ __html: `You have the right to ask us for a copy of the personal data we hold about you, to have it corrected or deleted, to object to or restrict how we use it, and to receive it in a portable format. You may exercise any of these rights by emailing <strong>privacy@getsensai.co</strong>; we will respond within the period required by law.` }} />
